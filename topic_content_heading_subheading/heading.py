...
def generate_response(topics, tokens_to_use):
    ...
    for topic in topics:
        ...
        template = ('As an experienced data scientist and technical writer, generate a creative and engaging blog within 300-350 words'
                    ' for a blog about {topic}. Include headings and subheadings to structure the content. Make sure it is attractive and captivating to readers.')
        ...
        print("\nTokens used for this completion:", tokens_used)
